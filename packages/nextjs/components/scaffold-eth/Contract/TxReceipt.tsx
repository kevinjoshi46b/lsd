...
export const TxReceipt = (
  ...
  return (
    <div className="flex-wrap collapse collapse-arrow mb-2">
      ...
      <div className="collapse-title text-sm rounded-3xl peer-checked:rounded-b-none min-h-0 bg-base-200 py-1.5">
        <strong>Transaction Receipt</strong>
      </div>
      <div className="collapse-content overflow-auto bg-base-200 rounded-t-none rounded-3xl">
